...
public class Color  {
    ...
    //<editor-fold defaultstate="collapsed" desc="Comportamiento: Metodes/Operacions">
    ...
    public void setRed(int red) {
        if (red < MIN_VALUE || red > MAX_VALUE) {
            throw new IllegalArgumentException(String.format("Valor %d no es vￃﾡlido para la coordenada R. Valores vￃﾡlidos: %d - %d", red, MIN_VALUE, MAX_VALUE));
        }
        this.red = red;
    }
    ...
    public void setGreen(int green) {
        if (green < MIN_VALUE || green > MAX_VALUE) {
            throw new IllegalArgumentException(String.format("Valor %d no es vￃﾡlido para la coordenada G. Valores vￃﾡlidos: %d - %d", green, MIN_VALUE, MAX_VALUE));
        }
        this.green = green;
    }
    ...
    public void setBlue(int blue) {
        if (blue < MIN_VALUE || blue > MAX_VALUE) {
            throw new IllegalArgumentException(String.format("Valor %d no es vￃﾡlido para la coordenada B. Valores vￃﾡlidos: %d - %d", blue, MIN_VALUE, MAX_VALUE));
        }
        this.blue = blue;
    }
    //</editor-fold>

    //<editor-fold defaultstate="collapsed" desc="API publica del objeto">
    ...
    //<editor-fold defaultstate="collapsed" desc="Sobreescriptura de metodes">
    @Override
    ...
    //<editor-fold defaultstate="collapsed" desc="Metodes estatics o de classe">
